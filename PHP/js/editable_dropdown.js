...
//<SCRIPT LANGUAGE="JavaScript"> //Dropdown specific functions, which manipulate dropdown specific global variables
  ...
  var vEditableOptionText_A = "--type_in_other--";
  ...
  function fnChangeHandler_A(getdropdown)
  {
    ...
    if ((vPreviousSelectIndex_A == (getdropdown.options.length-1)) && (vSelectIndex_A != (getdropdown.options.length-1))&&(vSelectChange_A != 'MANUAL_CLICK'))
    // To Set value of Index variables - Subrata Chakrabarty
    {
      getdropdown[(getdropdown.options.length-1)].selected=true;
      vPreviousSelectIndex_A = vSelectIndex_A;
      vSelectIndex_A = getdropdown.options.selectedIndex;
  ...
  function fnKeyPressHandler_A(getdropdown, e)
  {
    ...
    if(getdropdown.options.length != 0)
    // if dropdown is not empty
      if (getdropdown.options.selectedIndex == (getdropdown.options.length-1))
      // if selected option the Editable option of the dropdown
      {

        var vEditString = getdropdown[getdropdown.options.length-1].value;
        ...
        // To handle addition of a character - Subrata Chakrabarty
        {
          ...
          if(e.which) //For Netscape
          {
            ...
            {
              if(i!=getdropdown.options.length-1)
        ...
        getdropdown.options[getdropdown.options.length-1].text = vEditString;
        getdropdown.options[getdropdown.options.length-1].value = vEditString;
