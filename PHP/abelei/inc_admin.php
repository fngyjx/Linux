...
?>
		<A HREF="project_management_front_desk.php">Front desk</A><BR><IMG SRC="images/spacer.gif" WIDTH="1" HEIGHT="7"><BR>
		<A HREF="project_management_projects.php">Project Log<!-- &#151;ADMIN --></A><BR><IMG SRC="images/spacer.gif" WIDTH="1" HEIGHT="7"><BR>
		...
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0">
			<TR><FORM METHOD="post" ACTION="project_management_admin.sales.php">
				...
				$sql = "SELECT * FROM projects LEFT JOIN customer_contacts USING(contact_id) LEFT JOIN customers USING(customer_id) WHERE status = 4 ORDER BY project_id" . $filter;   // AND salesperson = " . $_SESSION['user_id'] . "
		...
		<A HREF="admin_users.php">Users</A><BR><IMG SRC="images/spacer.gif" WIDTH="1" HEIGHT="7"><BR>
