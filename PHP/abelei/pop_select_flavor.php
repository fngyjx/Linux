		...
		<FORM><TABLE BORDER="0" CELLSPACING="0" CELLPADDING="3">
			...
			while ( $row = mysql_fetch_array($result) ) {
				...
				<TR BGCOLOR="<?php echo $bgcolor ?>" VALIGN=TOP>
					<TD><INPUT TYPE="button" VALUE="Select" CLASS="submit" onClick="window.location='pop_select_flavor.php?pni=<?php echo $row['ProductNumberInternal']?>&pne=<?php echo $row['ProductNumberExternal']?>&des=<?php echo $row['Designation']?>&ppp=<?php echo $lbsperpail?>&ppd=<?php echo $lbsperdrum?>'" STYLE="font-size:7pt"></TD>
					<TD><IMG SRC="images/spacer.gif" WIDTH="7" HEIGHT="1"></TD>
