...
$sql = "SELECT pricesheetmaster.ProductDesignation, pricesheetmaster.ProcessType, pricesheetmaster.DatePriced,
 pricesheetmaster.FOBLocation, pricesheetmaster.Terms, pricesheetmaster.Notes, pricesheetmaster.Packaged_In,
 ProductNumberExternal, productmaster.Designation, productmaster.ProductType,
 customers.name, (SELECT CONCAT( first_name,  ' ', last_name )
 FROM users WHERE user_id = SalesPersonEmployeeID) AS sales_name, (SELECT CONCAT( first_name,  ' ', last_name ) 
 FROM users WHERE user_id = Priced_ByEmployeeID) AS priced_name
...
<TABLE BORDER="0" WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
	<TR VALIGN=TOP>
		...
		<IMG SRC="../images/abelei_font.png" WIDTH="60" BORDER="0"></TD>
...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="3">
	...
	<TR>
		...
		<TD><IMG SRC="../images/spacer.gif" WIDTH="20" HEIGHT=1></TD>
		<TD><?php echo ($ProductDesignation != "" ) ? $ProductDesignation : $Designation ;?></TD>
	</TR>
	<TR>
		<TD><B>Customer:</B></TD>
		<TD><IMG SRC="../images/spacer.gif" WIDTH="20" HEIGHT=1></TD>
...
if ( $_REQUEST['locked'] == 0 ) {
	...
	$sql = "SELECT SUM(((Price * Percentage)*0.01)) AS total_price FROM pricesheetdetail WHERE PriceSheetNumber = " . $_GET['psn'];
	$result = mysql_query($sql, $link) or die (mysql_error()."<br />Couldn't execute query: $sql<BR><BR>");
	$row = mysql_fetch_array($result);
...
if ( $SellingPrice != 0 ) {
	$Material_Margin_Percentage = number_format(round(($SellingPrice - $Tot_Raw_Material_Costs) / $SellingPrice, 4), 4);
} else {
...
if ( $SellingPrice != 0 ) {
	$Operating_Margin_Percentage = number_format(round(($SellingPrice - $Total_Costs) / $SellingPrice, 4), 4);
} else {
...
<TABLE BORDER=0 CELLSPACING="0" CELLPADDING="4" BORDERCOLOR="#CDCDCD" BGCOLOR="white">
	...
	<TR ALIGN=RIGHT>
		...
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Material_Cost_Per_gallon;?></TD>
		<TD>$<?php echo $Material_COST_Per_Kilo;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Material_COST_Per_Liter;?></TD>
		<TD><?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : number_format($row_analysis['Lbs_Per_Gallon'], 2);?></TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><NOBR><B>Manufacturing Costs:</B></NOBR></TD>
		<TD>$<?php echo $Tot_Manufacturing_Costs;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Manufacturing_Costs_Per_Gal;?></TD>
		<TD>$<?php echo $Tot_Manufacturing_Costs_Per_Kg;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Manufacturing_Costs_Per_Liter;?></TD>
		<TD>&nbsp;</TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><B>Packaging Costs:</B></TD>
		<TD>$<?php echo number_format(round($row_analysis['PackagingCost'], 2), 2);?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Packaging_Costs_per_Gal;?></TD>
		<TD>$<?php echo $Tot_Packaging_Costs_per_Kg;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Packaging_Costs_per_Liter;?></TD>
		<TD>&nbsp;</TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><B>Shipping Costs:</B></TD>
		<TD>$<?php echo number_format(round($row_analysis['ShippingCost'], 2), 2);?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Shipping_Costs_Per_Gal;?></TD>
		<TD>$<?php echo $Tot_Shipping_Costs_Per_Kg;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Shipping_Costs_Per_Liter;?></TD>
		<TD>&nbsp;</TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><B>Adjustment:</B></TD>
		<TD>$<?php echo number_format(round($row_analysis['ManualAdjustment'], 2), 2);?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Manual_Adjustment_Costs_Per_Gal;?></TD>
		<TD>$<?php echo $Tot_Manual_Adjustment_Costs_Per_KG;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Tot_Manual_Adjustment_Costs_Per_Liter;?></TD>
		<TD>&nbsp;</TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><B>Total Costs:</B></TD>
		<TD>$<?php echo $Total_Costs;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Total_Costs_per_Gal;?></TD>
		<TD>$<?php echo $Total_Costs_per_KG;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Total_Costs_per_Liter;?></TD>
		<TD>&nbsp;</TD>
	</TR>
	...
	<TR ALIGN=RIGHT>
		...
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $SellingPrice_Per_Gal;?></TD>
		<TD>$<?php echo $SellingPrice_Per_KG;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $SellingPrice_Per_Liter;?></TD>
		<TD>&nbsp;</TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><B>Material Margin:</B></TD>
		<TD>$<?php echo $Material_Margin_Per_Pound;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Material_Margin_Per_gal;?></TD>
		<TD>$<?php echo $Material_Margin_Per_KG;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Material_Margin_Per_Liter;?></TD>
		<TD><?php echo $Material_Margin_Percentage*100;?>%</TD>
	</TR>
	<TR ALIGN=RIGHT>
		<TD ALIGN=LEFT><NOBR><B>Operating Margin:</B></NOBR></TD>
		<TD>$<?php echo $Operating_Margin_Per_Pound;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Operating_Margin_Per_Gal;?></TD>
		<TD>$<?php echo $Operating_Margin_Per_KG;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $Operating_Margin_Per_Liter;?></TD>
		<TD><?php echo $Operating_Margin_Percentage*100;?>%</TD>
	</TR>
	...
	<TR ALIGN=RIGHT>
		...
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $U_P_per_Gal;?></TD>
		<TD>$<?php echo $U_P_per_KG;?></TD>
		<TD>$<?php echo ( $ProductType == "SD" or $ProductType == "PLATED" ) ? 'N/A' : $U_P_per_Liter;?></TD>
	</TR>
</TABLE><BR>
