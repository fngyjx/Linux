...
$sql = "SELECT * FROM projects LEFT JOIN clients USING(client_id) LEFT JOIN companies USING(company_id) WHERE status = 2";
	...
	<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="2">
		...
		while ( $row = mysql_fetch_array($result) ) {
			...
			<TR BGCOLOR="<?php echo $bgcolor ?>" VALIGN=TOP>
				...
				<TD><IMG SRC="images/spacer.gif" WIDTH="15" HEIGHT="1"></TD>
				<TD><!-- <A HREF="project_info.php?new_id=<?php //echo $row['project_id'] ?>"> --><?php echo $row['company'] ?><!-- </A> --></TD>
				<TD><IMG SRC="images/spacer.gif" WIDTH="15" HEIGHT="1"></TD>
				<TD><?php
