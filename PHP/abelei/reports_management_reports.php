...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<TR>
		...
		<tr><TD align="center" valign="bottom" >
				<INPUT TYPE="submit" class="submit_big" onClick="popup('reports/raw_material_requirements.php')" VALUE="Raw Material Requirements 1">
		</TD></tr>
		<tr><TD align="center" valign="bottom" >
				<INPUT TYPE="submit" class="submit_big" onClick="popup('reports/raw_material_requirements_part2.php')" VALUE="Raw Material Requirements 2">
		</TD></tr>
	</table>
