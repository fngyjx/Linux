...
if ( mysql_num_rows($result) != 0 ) {
	while ( $row = mysql_fetch_array($result) ) {
		...
		mail($row['email'],"Sales follow up notification",wordwrap($message,72,"\r\n"),"From: noreply@abelei.com\r\nMIME-Version: 1.0\r\nContent-type: text/html; charset=iso-8859-1");
//		mail("moconnell@chicagoit.com","Sales follow up notification",wordwrap($message,72,"\r\n"),"From: noreply@abelei.com\r\nMIME-Version: 1.0\r\nContent-type: text/html; charset=iso-8859-1");
		// CHANGE "moconnell@chicagoit.com" TO $row['email'] AFTER TESTING IS DONE

	}
} else {
	mail("moconnell@chicagoit.com","Sales follow ups","No follow ups needed to be sent today.","From: noreply@abelei.com\r\nMIME-Version: 1.0\r\nContent-type: text/html; charset=iso-8859-1");
}
