		...
		$sql = "SELECT date_created, project_id, company, sent_to_front, status, due_date, summary, lab_comments, users.first_name, users.last_name, users.email, ( SELECT first_name
		FROM lab_assignees
		LEFT JOIN users
		USING ( user_id ) 
		...
		//$sql = "SELECT * FROM projects LEFT JOIN clients USING(client_id) LEFT JOIN companies USING(company_id) WHERE status = 2" . $filter;
		...
		if ( mysql_num_rows($result) > 0 ) {
			...
			<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="2">
				<TR>
					...
					<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
					<TD><B><A HREF="index.php?sortby=c&archives=<?php echo $archives;?>">Company</A></B></TD>
					<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
