		<A HREF="projects.php">Project Log<!-- &#151;SALES --></A><BR><IMG SRC="images/spacer.gif" WIDTH="1" HEIGHT="7"><BR>
		...
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0">
			<TR><FORM METHOD="post" ACTION="project_info.php">
				...
				$sql = "SELECT * FROM projects LEFT JOIN clients USING(client_id) LEFT JOIN companies USING(company_id) WHERE status = 4 AND salesperson = " . $_SESSION['user_id'] . " ORDER BY project_id" . $filter;
