...
if ( $_REQUEST['psn'] != '' and $_REQUEST['reprint'] != 1 ) {
	...
	VALUES (" . $_REQUEST['psn'] . ", " . $_REQUEST['address_id'] . ", '" . $_REQUEST['contact_name'] . "','".$_SESSION['first_nameCookie']." ".$_SESSION['last_nameCookie']." by letter')";
...
$message .= "<span STYLE=\"font-family:'Century Gothic'\" style='color:red' style='font-weight:900' style='font-size:small'>abelei</span> is pleased to provide price quotes on the flavors below.<BR><BR>";
...
$message .= "Unless you specify otherwise, <span STYLE=\"font-family:'Century Gothic'\" style='color:red' style='font-weight:900' style='font-size:small'>abelei</span> will ship orders by what we consider the most reliable and affordable carriers with respect to your requested arrival date. In these cases freight charges will be prepaid and added to your invoice. If you have a freight carrier and billing procedure that you prefer, please let us know. We will do our very best to accommodate you.<BR><BR>";

$message .= "On behalf of my colleagues, I thank you for your interest in <span STYLE=\"font-family:'Century Gothic'\" style='color:red' style='font-weight:900' style='font-size:small'>abelei flavors</span>, the source of good taste.<BR><BR>";

if ( $Priced_ByEmployeeID == 10 or $Priced_ByEmployeeID == 11 ) {
	$message .= "With Best Regards,<BR><BR>";
	$message .= "<IMG SRC='../images/signatures/" . $Priced_ByEmployeeID . ".png' HEIGHT='45'>";
	$message .= "<BR><BR>";
} else {
...
$message .= "<BR>";
$message .= "<span STYLE=\"font-family:'Century Gothic'\" style='color:red' style='font-weight:900' style='font-size:small'>abelei flavors</span><BR>";
