...
if ( !empty($_POST) ) {
	...
	$html .= '<TR VALIGN=TOP>';
	$html .= '<TD>';
	$html .= '<H2 CLASS="top">&nbsp;Vendor&nbsp;</H2>';
	$html .= '<TABLE BORDER="1" CELLSPACING="0" CELLPADDING="0" BORDERCOLOR="#CDCDCD"><TR><TD>';
	$html .= '<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="10" BGCOLOR="white"><TR><TD>';
	$html .= '<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="0" WIDTH=330>';
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>Name:</B></TD>';
	$html .= '<TD>' . stripslashes($VendorName) . '</TD>';
	$html .= '</TR>';
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>Address:</B></TD>';
	$html .= '<TD>' . $VendorStreetAddress1 . '</TD>';
	$html .= '</TR>';
	if ( $VendorStreetAddress2 != "" ) {
		$html .= '<TR>';
		$html .= '<TD STYLE="text-align:right"></TD>';
		$html .= '<TD>' . $VendorStreetAddress2 . '</TD>';
		$html .= '</TR>';
	}
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>City:</B></TD>';
	$html .= '<TD>' . $VendorCity . ', ' . $VendorState . ' ' . $VendorZipCode;
	$html .= '</TD>';
	$html .= '</TR>';
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>Phone:</B></TD>';
	$html .= '<TD>' . $VendorMainPhoneNumber . '</TD>';
	$html .= '</TR>';
	$html .= '</TABLE>';
	$html .= '</TD></TR></TABLE>';
	$html .= '</TD></TR></TABLE>';
	...
	$html .= '</TD>';
	$html .= '<TD WIDTH=20><IMG SRC="images/spacer.gif" WIDTH="20" HEIGHT="1"></TD>';
	$html .= '<TD>';

	$html .= '<H2 CLASS="top">&nbsp;Ship To&nbsp;</H2>';
	...
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>Name:</B></TD>';
	$html .= '<TD>' . $ShipToName . '</TD>';
	$html .= '</TR>';
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>Address:</B></TD>';
	$html .= '<TD>' . $ShipToStreetAddress1 . '</TD>';
	$html .= '</TR>';
	if ( $VendorStreetAddress2 != '' ) {
		$html .= '<TR>';
		$html .= '<TD STYLE="text-align:right"></TD>';
		$html .= '<TD>' . $ShipToStreetAddress2 . '</TD>';
		$html .= '</TR>';
	}
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>City:</B></TD>';
	$html .= '<TD>' . $ShipToCity . ', ' . $ShipToState . ' ' . $ShipToZipCode . '</TD>';
	$html .= '</TR>';
	$html .= '<TR>';
	$html .= '<TD STYLE="text-align:right"><B>Phone:</B></TD>';
	$html .= '<TD>' . $ShipToMainPhoneNumber . '</TD>';
	$html .= '</TR>';
	$html .= '</TABLE>';
	$html .= '</TD></TR></TABLE>';
	$html .= '</TD></TR></TABLE>';
	...
	$html .= '</TABLE><BR><BR>';
		...
		$file = $row['name'] . "-" . $row['ProductNumberExternal'];
