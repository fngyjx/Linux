...
$sql = "SELECT ProductMaster.ProductNumberInternal, ProductMaster.Designation ";
...
$sql .= "WHERE ( ( ( ( ProductMaster.ProductNumberInternal ) LIKE '2%' ) OR ( ( ProductMaster.ProductNumberInternal ) LIKE '5%' ) ) AND ( ( ProductMaster.Designation ) LIKE '%$q%' ) ) ";
...
if (0 < $result_count)
{
	while ( $row = mysql_fetch_array($result, MYSQL_ASSOC) ) {
		echo $row["Designation"]."|".$row["ProductNumberInternal"]."\n";
	}
}
?>