...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<TR>
		...
		<TD><SELECT NAME="customer_and_address" <?php echo $form_status ?> STYLE="font-size:7pt">
		<?php
		if ( $_REQUEST['cust_id'] != '' ) {
		...
		if ( mysql_num_rows($result_customers) != 0 ) {
			while ( $row_customers = mysql_fetch_array($result_customers) ) {
				if ( $customer_id == $row_customers['customer_id'] and $address_id == $row_customers['address_id'] ) {
					echo "<OPTION VALUE='" . $row_customers['customer_id'] . "|" . $row_customers['address_id'] . "' SELECTED>" . $row_customers['name'] . " (" . $row_customers['address1'] . " " . $row_customers['address2'] . ", " . $row_customers['city'] . ", " . $row_customers['state'] . ")</OPTION>";
				} else {
					echo "<OPTION VALUE='" . $row_customers['customer_id'] . "|" . $row_customers['address_id'] . "'>" . $row_customers['name'] . " (" . $row_customers['address1'] . " " . $row_customers['address2'] . ", " . $row_customers['city'] . ", " . $row_customers['state'] . ")</OPTION>";
				}
			}
	 	}
		?>
