		...
		<SELECT NAME="vendor_id" <?php echo $radio_check;?>>
			...
			while ( $row = mysql_fetch_array($result) ) {
				if ( $vendor_id == $row['vendor_id'] or $_REQUEST['vend_id'] == $row['vendor_id'] )  {   //  and $vendor_address_id == $row['address_id']
					echo "<OPTION VALUE='" . $row['vendor_id'] . "~" . $row['address_id'] . "' SELECTED>" . $row['name'] . " (" . $row['city'] . ", " . $row['state'] . ")</OPTION>";
				} else {
					echo "<OPTION VALUE='" . $row['vendor_id'] . "~" . $row['address_id'] . "'>" . $row['name'] . " (" . $row['city'] . ", " . $row['state'] . ")</OPTION>";
				}
			} ?>
		</SELECT>
	<?php }
