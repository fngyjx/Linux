...
if ( !empty($_POST) ) {
	...
	$sql = "SELECT DISTINCT vendors.name AS vendor, productmaster.Natural_OR_Artificial, productmaster.Designation,
	productmaster.ProductType, productmaster.Kosher, productmaster.UnitOfMeasure, ProductNumberExternal,
	productmaster.ProductNumberInternal, ShippingDate, DateOrderPlaced, purchaseordermaster.PurchaseOrderNumber,
	purchaseorderdetail.Quantity, purchaseorderdetail.PackSize, purchaseorderdetail.UnitOfMeasure
