...
$sql = "SELECT first_name, last_name, name, application FROM projects LEFT JOIN customer_contacts USING(contact_id) LEFT JOIN customers USING(customer_id) WHERE project_id = " . $_GET['pid'];
