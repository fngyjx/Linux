...
switch ($rights) {
	case 1: // ADMIN   //"front_desk" => "Front Desk", 
		...
		$flavors_rolls = array("flavors_formulations"=>"Formulations", "flavors_materials"=>"Materials", "flavors_materials_pricing"=>"Materials Pricing", "flavors_qc_formulas"=>"QC Formulas", "flavors_regulatory_reports"=>"Regulatory Reports");
		$customers_rolls = array("customers_quotes"=>"Quotes", "customers_multiple_quotes"=>"Multiple Quotes", "customers_customer_order_shipping"=>"Orders/Shipping", "customers_batch_sheets"=>"Batch Sheets", "customers_customers"=>"Customers", "customers_contacts"=>"Contacts");
		$vendors_rolls = array("vendors_pos"=>"POs", "vendors_receipts"=>"Receipts", "vendors_vendors"=>"Vendors", "vendors_contacts"=>"Contacts");
		$inventory_rolls = array("inventory_inventory_maintenance"=>"Inventory Maintenance");
		$reports_rolls = array("reports_management_reports"=>"Management Reports", "reports_regulatory_reports"=>"Regulatory Reports");
		$admin_rolls = array("admin_users"=>"Users");
		$topmenuwidth="634";
		break;
	case 2: // SALES
		...
		$project_management_rolls = array("project_management_admin"=>"Admin", "project_management_projects"=>"Projects", "project_management_completed"=>"Completed");
		$customers_rolls = array("customers_customers"=>"Customers", "customers_contacts"=>"Contacts");
		$topmenuwidth="300";
		break;
	case 3: // LAB
		...
		$flavors_rolls = array("flavors_formulations"=>"Formulations", "flavors_materials"=>"Materials", "flavors_materials_pricing"=>"Materials Pricing", "flavors_qc_formulas"=>"QC Formulas", "flavors_regulatory_reports"=>"Regulatory Reports");
		$vendors_rolls = array("vendors_vendors"=>"Vendors", "vendors_contacts"=>"Contacts");
		$topmenuwidth="334";
		break;
	case 4: // FRONT DESK   //"front_desk" => "Front Desk", 
		...
		$front_desk_rolls = array("front_desk_labels" => "Labels", "front_desk_bill_of_lading"=>"Bills of Lading", "front_desk_truck_quote"=>"Truck Quote", "front_desk_packing_list"=>"Packing List", "front_desk_supplemental_documents"=>"Supplemental Documents");
		$project_management_rolls = array("project_management_admin"=>"Admin", "project_management_completed"=>"Completed");
		$flavors_rolls = array("flavors_formulations"=>"Formulations", "flavors_materials_pricing"=>"Materials Pricing");
		$customers_rolls = array("customers_customer_order_shipping"=>"Orders/Shipping", "customers_customers"=>"Customers", "customers_contacts"=>"Contacts");
