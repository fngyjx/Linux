...
$sql = "SELECT project_id, date_created, name, parent_id, project_type, status, due_date, summary, users.last_name, users.first_name, sent_to_front, ( SELECT first_name
FROM lab_assignees
LEFT JOIN users
USING ( user_id ) 
...
if ( mysql_num_rows($result) > 0 ) {
	...
	<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="2">
		<TR>
			<TD><B><A HREF="project_management_projects.php?sortby=p">Project#</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=dc">Created</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=c">Customer</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=sp">Sales</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=a">Assigns</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=s">Status</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=cp">Completed</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B><A HREF="project_management_projects.php?sortby=d">Due</A></B></TD>
			<TD><IMG SRC="images/spacer.gif" WIDTH="10" HEIGHT="1"></TD>
			<TD><B>Summary</B></TD>
			<TD COLSPAN=2></TD>
		</TR>
...
function cancel_project(pid) {
	if ( confirm('Are you sure you want to cancal this project?') ) {
		document.location.href = "project_management_admin.sales.php?stat=5&pid=" + pid
	}
}
