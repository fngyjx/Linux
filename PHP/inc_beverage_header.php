...
switch ($rights) {
	case 1: // ADMIN   //"front_desk" => "Front Desk", 
		$arrays = array("project_management" => "Project Managment", "flavors" => "Flavors and Materials", "customers_beverage" => "Customers", "vendors_beverage" => "Vendors", "inventory" => "Inventory", "admin" => "Admin", "reports" => "Reports");   //"front_desk", 
		$main_rolls = array("project_management", "flavors", "customers_beverage", "vendors_beverage", "inventory", "reports", "admin", "logout");
		...
		$vendors_beverage_rolls = array("vendors_beverage_pos"=>"POs", "vendors_beverage_receipts"=>"Receipts", "vendors_beverage_vendors"=>"Vendors", "vendors_beverage_contacts"=>"Contacts","vendors_beverage_products"=>"Products","vendors"=>"Ingredient");
	...
	case 2: // SALES
		...
		$main_rolls = array("project_management","customers_beverage", "logout");
		$project_management_rolls = array("project_management_admin"=>"Admin", "project_management_projects"=>"Projects", "project_management_completed"=>"Completed");
	...
	case 3: // LAB
		...
		$main_rolls = array("project_management", "flavors", "vendors_beverage", "logout");
	...
	case 4: // FRONT DESK   //"front_desk" => "Front Desk", 
		...
		$main_rolls = array("project_management", "flavors", "customers_beverage", "reports", "logout");
		$front_desk_rolls = array("front_desk_labels" => "Labels", "front_desk_bill_of_lading"=>"Bills of Lading", "front_desk_truck_quote"=>"Truck Quote", "front_desk_packing_list"=>"Packing List", "front_desk_supplemental_documents"=>"Supplemental Documents");
		$project_management_rolls = array("project_management_admin"=>"Admin", "project_management_completed"=>"Completed");
	...
	case 5: // QUALITY CONTROL
		$arrays = array("project_management" => "Project Managment", "flavors" => "Flavors and Materials", "vendors" => "Vendors", "inventory" => "Inventory", "reports" => "Reports");
		$main_rolls = array("project_management", "flavors", "vendors_beverage", "inventory", "logout");
		$project_management_rolls = array("project_management_admin"=>"Admin", "project_management_completed"=>"Completed");
		$flavors_rolls = array("flavors_beverage_formulations"=>"Beverages","flavors_formulations"=>"Formulations", "flavors_materials"=>"Materials", "flavors_materials_pricing"=>"Materials Pricing", "flavors_qc_formulas"=>"QC Formulas", "flavors_regulatory_reports"=>"Regulatory Reports");
	...
	case 6: // LAB + LIMITTED QC
		...
		$main_rolls = array("project_management", "flavors", "customers_beverage", "logout");
		$project_management_rolls = array("project_management_admin"=>"Admin", "project_management_completed"=>"Completed");
		$flavors_rolls = array("flavors_beverage_formulations"=>"Beverages","flavors_formulations"=>"Formulations", "flavors_materials"=>"Materials", "flavors_materials_pricing"=>"Materials Pricing", "flavors_qc_formulas"=>"QC Formulas", "flavors_regulatory_reports"=>"Regulatory Reports");
   ...
   <!-- Hide
	...
	<?php
		...
		foreach ( $arrays as $value => $title) {
			//$value=str_replace("_beverage_ingredient","",$value); 
            ...
            echo "\$beginning_string=[".$beginning_string."] \$value=[".$value."]\n";
			if ( $beginning_string == $value ) {
				foreach ( ${$value . "_rolls"} as $roll => $section) {
					//if ( $section == "Ingredient" ) {
					echo $roll . "Out = new Image;\n";
					echo $roll . "Out.src = \"images/submenu/" . str_replace("_beverage","",$roll) . "_out.gif\";\n";
					echo $roll . "Over = new Image\n";
					echo $roll . "Over.src = \"images/submenu/" . str_replace("_beverage","",$roll) . "_over.gif\";\n";
					echo $roll . "Hover = new Image\n";
					echo $roll . "Hover.src = \"images/submenu/" . str_replace("_beverage","",$roll) . "_hover.gif\";\n\n";
					//} else {
					//echo $roll . "Out = new Image;\n";
	...
	foreach ( $arrays as $value => $title) {
		...
		if ( $beginning_string == $value ) {
			...
			foreach ( ${$value . "_rolls"} as $roll => $section ) {
				...
				echo "HREF='" . $url . "'><IMG SRC='images/submenu/" . str_replace("_beverage","",$roll) . "_" . strtolower($roll_state) . ".gif' BORDER=0 NAME='" . $roll . "' ALT='" . $roll . "'></A></TD>\n";
