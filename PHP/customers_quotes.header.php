...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="3">
	<TR>
		...
		while ( $row_sales = mysql_fetch_array($result_sales) ) {
			if ( $SalesPersonEmployeeID == $row_sales['user_id'] or $row_sales['user_id'] == 10 ) {
	...
	<TR>
		...
		while ( $row_priced = mysql_fetch_array($result_priced) ) {
			if ( $Priced_ByEmployeeID == $row_priced['user_id'] or $row_priced['user_id'] == 10 ) {
	...
	<TR>
		<TD><B>Min Order:</B></TD>
		<TD><NOBR><INPUT TYPE="text" NAME="MinBatch" VALUE="<?php echo ($MinBatch >0 ) ? $MinBatch : 1;?>" SIZE=14 <?php echo $form_status;?>> <!-- <I><?php //echo $MinBatch_Units;?></I> --> 
